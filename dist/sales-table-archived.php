...
<head>
    ...
    <title>Sales (Archived) - Mance Bicycle Shop</title>
                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Sales (Archived)</h3>
                            </div>
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Sales (Archived)
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <?php if (isset($_GET['restore-success'])) { ?>
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    Sale move to restore successfully.
                            ...
                            <div class="card-body">
                                <table class="table table-striped" id="table1">
                                    ...
                                    <tbody>
                                        <?php include_once ('functions/sales-table-all-archived.php'); ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
