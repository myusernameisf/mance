<?php
    ...
    $stmt = $connection->prepare("UPDATE tblexpenses SET exp_receiptno = ?, exp_supplier = ?, exp_qty = ?, exp_unitprice = ?, exp_date = ? WHERE exp_ID = ?");
    $stmt->execute([$receiptno,$supplier,$qty,$unitprice,$date,$id]);
