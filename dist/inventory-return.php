...
<head>
    ...
    <title>Supplier Return - Mance Bicycle Shop</title>
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Supplier Return
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-striped" id="table1">
                                    ...
                                    <tbody>
                                        <?php include_once ('functions/return-supplier-table.php'); ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
