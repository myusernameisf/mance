...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2023 at 03:27 AM
...
INSERT INTO `tblinventory` (`inv_ID`, `inv_productID`, `inv_brandname`, `inv_name`, `inv_qty`, `inv_unitprice`, `inv_sellingprice`, `inv_lowstocknotif`, `inv_isTrash`) VALUES
(4, 4, 'SHIMANO', 'ALTUS', 47, 1000, 2000, 20, 0),
(5, 6, 'SHIMANO', 'DEORE', 78, 10000, 15000, 10, 0);
...
INSERT INTO `tblproducts` (`prd_ID`, `prd_brandname`, `prd_name`, `prd_category`, `prd_isTrash`, `prd_date`) VALUES
(4, 'SHIMANO', 'ALTUS', 'shifter', 0, '2023-09-15'),
